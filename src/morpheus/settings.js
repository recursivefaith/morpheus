...
export default class MorpheusSettingsTab extends PluginSettingTab {
  ...
  display() {
    ...
    new Setting(this.containerEl)
      ...
      .setDesc(
        'Choose a file for the global system prompt, which is used to set the default voice and behavior'
      )
      .addSearch((searchComponent) => {
        new FileSuggest(this.app, searchComponent.inputEl);
        searchComponent
          .setPlaceholder('Type to search for a file...')
    ...
    new Setting(this.containerEl)
      ...
      .setDesc(
        'Choose a file for the global skill prompt, which is used to select skills to use'
      )
      .addSearch((searchComponent) => {
        new FileSuggest(this.app, searchComponent.inputEl);
        searchComponent
    ...
    new Setting(this.containerEl)
      ...
      .setDesc(
        'Choose a file for the global planning prompt, which is used to create a plan of action'
      )
      .addSearch((searchComponent) => {
        new FileSuggest(this.app, searchComponent.inputEl);
        searchComponent
    ...
    new Setting(this.containerEl)
      ...
      .addSearch((searchComponent) => {
        ...
        searchComponent
          .setPlaceholder('Type to search for a folder...')
